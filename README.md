...
_Start Node.js server_
npm run start:server

- Configure access to Mongo DB in cloud
  URL: mongodb+srv://<username>:<password>@sc.p1yjd5w.mongodb.net/shop?retryWrites=true&w=majority

UserId: esche
Password: mongoDBPassword

mongodb+srv://esche:mongoDBPassword@sc.p1yjd5w.mongodb.net/shop?retryWrites=true&w=majority
